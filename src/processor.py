...
4. Si es un artículo dentro de un libro o un capítulo, extrae el título del libro como 'title' y el título del capítulo como 'chapter_title'.

Para cada entrada, extrae: autor, año, título, editorial, URL, tipo y título de capítulo (si aplica).

Retorna JSON:
{{
  "basic": [
    {{"author": "...", "year": "...", "title": "...", "publisher": "...", "type": "...", "chapter_title": "..."}},
    ...
  ],
  "complementary": [
    ...
        ...
        for entrada in entradas:
            ...
            if titulo:
                ...
                titulo = Titulo(
                    ...
                    type_bib=tipo_bib,
                    chapter=entrada.get('chapter_title'),
                ...
                if detalles_primo:
                    ...
                    if detalles_primo.get('lugar'): titulo.place = detalles_primo['lugar']
